...
spv <- function(dt){
  ...
  for(i in unique(lv[,1])) {
    ...
    legend(0.91, 0.37, legend=c(paste0('Mean FPR (range): ', round(mean(idx$fpr),digits=1), ' (',min(idx$fpr), ' to ', max(idx$fpr), ')'),
                                paste0('Mean FNR (range): ', round(mean(idx$fnr),digits=1), ' (',min(idx$fnr), ' to ', max(idx$fnr), ')'),
                                paste0('Mean FL (range): ', round(mean(idx$fl),digits=1), ' (',min(idx$fl), ' to ', max(idx$fl), ')'),
                                paste0('Mean MD (range): ', round(mean(md),digits=1), ' (',round(min(md),digits=1), ' to ', round(max(md),digits=1),')') ),
          cex=3, bty='n', y.intersp=1.3, adj=1)
    
    par(mar=c(15,9,5,6),  mgp=c(3,2,5))
    plot(idx$date[1:nrow(idx)], md, bty='n', pch=19, col='maroon',
         cex=7, cex.axis=2.5, cex.main=2, xlab='', ylab='', ylim=c(-12,2))
    ...
    par(mar=c(5,4,0,2))
    plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    legend(-0.03,1.1, legend=c(idx$date[1:3]), cex=4.3, text.font=2, bty='n', y.intersp=2,
    ...
    plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    legend(0.06,1.07, legend=c(idx$date[4:6]), cex=2.8, text.font=2, bty='n', y.intersp=2,
           text.col='lightsteelblue')
    ...
    plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    legend(0.06,1.07, legend=c(idx$date[7:9]), cex=2.8, text.font=2, bty='n', y.intersp=2,
           text.col='lightsteelblue')
    ...
    plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    legend(0.06,1.07, legend=c(idx$date[10:12]), cex=2.8, text.font=2, bty='n', y.intersp=2,
           text.col='lightsteelblue')
    ...
    # plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    # legend(0.06,1.07, legend=c(idx$date[13:15]), cex=2.8, text.font=2, bty='n', y.intersp=2,
    #        text.col='lightsteelblue')
    ...
    # 
    # plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    # legend(0.06,1.07, legend=c(idx$date[16:18]), cex=2.8, text.font=2, bty='n', y.intersp=2,
    #        text.col='lightsteelblue')
    ...
    # 
    # plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    # legend(0.06,1.07, legend=c(idx$date[19:21]), cex=2.8, text.font=2, bty='n', y.intersp=2,
    #        text.col='lightsteelblue')
    ...
    # 
    # plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    # legend(0.06,1.07, legend=c(idx$date[22:24]), cex=2.8, text.font=2, bty='n', y.intersp=2,
    #        text.col='lightsteelblue')
    ...
    # 
    # plot(0, xlim=c(0,1), ylim=c(0,1), ann=FALSE, axes=FALSE, type='n')
    # legend(0.06,1.07, legend=c(idx$date[25:27]), cex=2.8, text.font=2, bty='n', y.intersp=2,
    #        text.col='lightsteelblue')
